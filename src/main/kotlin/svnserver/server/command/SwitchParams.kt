...
) : DeltaParams(rev, target, url, true, Depth.parse(depth, recurse, Depth.Files), if (sendCopyFromArgs) SendCopyFrom.Always else SendCopyFrom.Never, ignoreAncestry, true, 0)
