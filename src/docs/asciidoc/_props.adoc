...
Because of this arbitrary `svn properties` is not supported.
To value `svn properties` correspond Git-view, they are generated on the fly based on the repository content.`
