origin: https://github.com/bozaro/git-as-svn // fork-maintenance CP-AL00139: канон/upstream для обновления форка; наш форк: AlexanderSemenyak/git-as-svn; зеркало: onit/devops/git-as-svn
